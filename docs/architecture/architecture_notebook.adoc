...
* Das Ziel sollte stets sein, dass der User einen einfachen und struktierten Durchlauf seiner Bestellung verzeichnen kann.

* Ebenfalls ist es ein wichtiges Ziel, den Datenschutz zu gewährleisten, damit der User eine gute Vertrauensbasis zum System aufbaut

* Es sollte einfach zu warten und zu pflegen sein
...
* Das System läuft in einer sicheren Umgebung, dies betrifft die thermischen, sicherheits- und anbindungsrelevanten Aspekte

* Das System wird immer von einer eingewiesenen Person installiert & gewartet

== Architektur-relevante Anforderungen
//Fügen Sie eine Referenz / Link zu den Anforderungen ein, die implementiert werden müssen, um die Architektur zu erzeugen.
* Ein Zugang zum World Wide Web muss bestehen
